...
var MapDataLoader = {
    ...
    plotRelationsOnMap: function (pgisMap, relations) {
        ...
        _.each(relations, function (relation) {
            ...
            // if relation with this id was previously selected for sidebar, highlight it
            //  This is needed because when clicked on a relation, the display of sidebar
            //  moved the map triggering a reload of data and render of the layers
    ...
    plotTransnetOnMap: function (pgisMap, transnetData) {
        ...
        _.each(transnetData, function (transnetSection) {
